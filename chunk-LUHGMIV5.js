  ...
  type: [
    {
      light: {
        ...
        onRoot: {
          ...
          '--po-density-block-spacing': '1rem'; /* Espa\xE7o interno entre o header e o content (inclui pages, tabs e stepper) */
          '--po-density-gap-header-content': '1rem'; /* Espa\xE7o interno entre blocos de conte\xFAdo do header e content (inclui dividers e gaps) */
        },
        perComponent: {
          'po-button': {
