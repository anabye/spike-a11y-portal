import{n as z,o as X,p as U}from"./chunk-CAIN5BOP.js";import{O as B,a as V,mb as W,y as j,yb as M,zb as w}from"./chunk-XLFDPJQH.js";import{Aa as d,Bb as D,Cc as O,Da as y,Dc as N,Ec as k,Fc as F,Gc as L,La as o,Ma as t,N as S,Na as s,Ra as I,Sa as c,Tc as A,U as g,V as h,Vc as R,Xc as _,Zb as q,cb as e,eb as H,gb as v,hb as P,ib as C,ja as l,ka as E,lb as T,qa as u,ra as x}from"./chunk-S7P3J2XO.js";var J=(()=>{class n{http;headerParam;requestMessage;status;errorMessage=`{
    "code": "401",
...
...
`),t()(),o(160,"blockquote")(161,"p"),e(162,"Ap\xF3s a valida\xE7\xE3o no "),o(163,"em"),e(164,"interceptor"),t(),e(165,", os par\xE2metros ser\xE3o removidos do cabe\xE7alho da requisi\xE7\xE3o. "),t()()()())},encapsulation:2})}return n})();var Y=(()=>{class n{route;router;sub;hidePoWebSample=!0;samplesLength=1;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"an an-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(r,a){this.route=r,this.router=a}goBack(){this.router.navigate(["documentation"])}improveDocs(){this.router.navigate(["guides/development-flow"])}ngOnInit(){this.sub=this.route.queryParams.subscribe(r=>{let a=r.view;this.activeTab=a||"doc",this.hidePoWebSample=this.samplesLength===0})}changeTab(r){this.router.navigate([],{queryParams:{view:r},queryParamsHandling:"merge"}),this.activeTab=r}ngOnDestroy(){this.sub.unsubscribe()}static \u0275fac=function(a){return new(a||n)(E(A),E(R))};static \u0275cmp=u({type:n,selectors:[["ng-component"]],standalone:!1,decls:6,vars:4,consts:[["p-title","Http Interceptor",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-click","p-active"],["p-label","Exemplos",3,"p-click","p-hide","p-active"]],template:function(a,i){a&1&&(o(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),c("p-click",function(){return i.changeTab("doc")}),s(3,"sample-po-http-interceptor-doc"),t(),o(4,"po-tab",3),c("p-click",function(){return i.changeTab("web")}),s(5,"sample-po-http-interceptor-labs-view"),t()()()),a&2&&(d("p-actions",i.actions),l(2),d("p-active",i.activeTab==="doc"),l(2),d("p-hide",i.hidePoWebSample)("p-active",i.activeTab==="web"))},dependencies:[W,M,w,K,Q],encapsulation:2})}return n})();var ne=[{path:"",component:Y}],Z=(()=>{class n{static \u0275fac=function(a){return new(a||n)};static \u0275mod=x({type:n});static \u0275inj=S({imports:[_.forChild(ne),_]})}return n})();var Me=(()=>{class n{static \u0275fac=function(a){return new(a||n)};static \u0275mod=x({type:n});static \u0275inj=S({imports:[U,Z]})}return n})();export{Me as DocPoHttpInterceptorModule};
